...
<div class="banner-bottom">
        ...
        <?php endif; ?>
				...
				<div class="single-page">
							...
							<div class="single-pg-hdr">
												...
												<h2><?php echo e(isset($listing->property_name)?$listing->property_name:''); ?></h2>
												<p>Location: <?php echo e(isset($listing->location)?$listing->location:''); ?></p>
												<!-- <p>Jump to: <a href="#">Over View</a>|<a href="#">Room Choices</a>|<a href="#">Hotel Information</a></p> -->

												</div>
												<div class="row">
												 <div class="col">
                                            <img class="img-fluid" src="../images/l5.jpg" alt="logo">
                                                </div>
												</div>
												
												<p>
													<h1>About  <?php echo e(isset($listing->property_name)?$listing->property_name:''); ?></h1>
                                                     <?php echo e(isset($listing->Description)?$listing->Description:''); ?>
						...
						<div class="col-md-4 single-gd-rt">
							<div class="spl-btn">
								...
								<div class="sp-bor-btn text-right">
                                    <?php echo e(isset($listing->property_name)?$listing->property_name:''); ?>

									<h4><span>Ksh 8,750</span> <?php echo e(isset($listing->price_per_person)?$listing->price_per_person:''); ?></h4>
 ...
 <div class="col-sm-12" align="center">
        ...
        <form id='form-id'>
		<?php echo csrf_field(); ?>
            <input id='watch-me' name='test' type='radio' checked /> Classroom
            <input id='see-me' name='test' type='radio' /> Theatre
            <input id='look-me' name='test' type='radio' /> U-shaped
        </form>
        <br><br>
        <div id='show-me'>
            <!-- Nav tabs -->
					...
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="<?php echo e(route('book.show')); ?>"><img class="img-fluid" src="../images/l5.jpg" alt="logo">
          </a></a>
								<div class="room-basic-info">
									<a href="<?php echo e(route('book.show')); ?>">Classroom Conference Room</a>
									<h6>Room Capacity:</h6>
									<p><?php echo e(isset($listing->Capacity)?$listing->Capacity:''); ?> People</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								...
								<p>Price is now:</p>
								<span class="p-offer">Ksh <?php echo e(isset($listing->price_per_metre)?$listing->price_per_person:''); ?></span>
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
									<form action="<?php echo e(route('cart.store',$listing)); ?>" method="POST">
										<?php echo csrf_field(); ?>
								<input type="hidden" name="id" value="<?php echo e($listing->id); ?>">
								<input type="hidden" name="property_name" value="<?php echo e($listing->property_name); ?>">
								<input type="hidden" name="price_per_hall" value="<?php echo e($listing->price_per_person); ?>">
        ...
        <div id='show-me-two' style='display:none; border:2px solid #ccc'><div class="p-table">
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="#"><img class="img-fluid" src="../images/l5.jpg" alt="logo">
          </a></a>
								<div class="room-basic-info">
									<a href="book">U-Shaped Conference Room</a>
									<h6>Room Capacity:</h6>
									<p><?php echo e(isset($listing->Capacity)?$listing->Capacity:''); ?> People</p>
								</div>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer"><?php echo e(isset($listing->price_per_hall)?$listing->price_per_metre:''); ?></span>
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
								...
								<input type="hidden" name="id" value="<?php echo e($listing->id); ?>">
								<input type="hidden" name="property_name" value="<?php echo e($listing->property_name); ?>">
								<input type="hidden" name="price_per_hall" value="<?php echo e($listing->price_per_metre); ?>">
								<button type="submit" class="button-button-primary">Book</button>
							</form>
							</div>
						</div>
       ...
       <div id='show-me-three' style='display:none; border:2px solid #ccc'><div class="p-table">
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer"><?php echo e(isset($listing->price_per_hall)?$listing->price_per_hall:''); ?></span>
								<span class="p-last-price">Ksh23,000</span>
							</div>
						</div>
						 <div class="row">
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
								...
								<input type="hidden" name="id" value="<?php echo e($listing->id); ?>">
								<input type="hidden" name="property_name" value="<?php echo e($listing->property_name); ?>">
								<input type="hidden" name="price_per_hall" value="<?php echo e($listing->price_per_hall); ?>">
								<button type="submit" class="button-button-primary">Book</button>
							</form>
							</div>
						</div>
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								...
								<div class="room-basic-info">
									<a href="book">U-Shaped Conference Room</a>
									<h6>Room Capacity:</h6>
									<p><?php echo e($listing->Capacity); ?> People</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer"><?php echo e($listing->price_per_hall); ?></span>
								<span class="p-last-price">Ksh23,000</span>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">Ksh <?php echo e($listing->price_per_metre); ?></span>
								<span class="p-last-price">Ksh1930</span>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
					...
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								...
								<div class="room-basic-info">
									<a href="<?php echo e(route('book.show')); ?>">Theatre Confrerence Room</a>
									<h6>Room Capacity:</h6>
									<p><?php echo e($listing->Capacity); ?> People</p>
								</div>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">Ksh <?php echo e($listing->price_per_person); ?></span>
