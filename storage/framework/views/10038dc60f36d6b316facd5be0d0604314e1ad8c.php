	...
	<div class="search">
		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="col fill_height">
					...
					<div class="search_panel active">
						<form action="<?php echo e(route('search')); ?>"method="GET" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
								...
								<div>City</div>
										...
										<i class="fa fa-search search-icon"></i>
											 <!-- <input type="text" name="query" id="query" value="<?php echo e(request()->input('query')); ?>" class="search-box" placeholder="Search for product" required> -->
											 	<input type="search" name="query" id="query" value="<?php echo e(request()->input('query')); ?>" class="destination search_input" placeholder="Your search begins here" autocomplete="on" required="required">
                    ...
                    <div class="col">
						...
						<label class="checkbox-inline">
						  <input type="checkbox" id="Check3" value="Bootstrap" > Biscuits
								   ...
								   <div class="col">
										<div class="form-group">
						      <button class="button search_button" id="query" name="query" value="<?php echo e(request()->input('query')); ?>" style="margin-right:38px">search<span></span><span></span><span></span></button>
					            </div>
			</form>
								  </div>
								</div>  
			...
			<div class="row intro_items">
               ...
               <div class="form-group">
			     <?php $__currentLoopData = $listings->slice(0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					   <?php echo e($loop->parent); ?> 
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							...
							<div class="button intro_button"><div class="button_bcg"></div><a href="<?php echo e(route('product.show',$listing->property_name)); ?>">Book Now<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1><?php echo e($listing->property_name); ?></h1>
								<div class="intro_price">Ksh <?php echo e($listing->price_per_hall); ?></div>
...
<br>
       ...
       <div class="form-group">
	   <?php $__currentLoopData = $listings->slice(0, 9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   <?php echo e($loop->parent); ?> 
   	    <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="<?php echo e(route('product.show',$listing->property_name)); ?>">
			    <img src="images/l5.jpg" class="img-responsive" alt=""/>
			    <div class="ribbon green"><span>Ksh <?php echo e($listing->price_per_hall); ?></span></div>
				<span class="sale-box">
				  <span class="sale-label">-17%</span>
			    </span>
				</a>
				<div class="living_desc">
				<h3><a href="product"><?php echo e($listing->property_name); ?></a></h3>
				<p>Location: <?php echo e($listing->location); ?> </p>
				<ul><span class="glyphicon glyphicon-star" aria-hidden="true"></span>
				<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
		        </ul>
				<a href="<?php echo e(route('product.show',$listing->property_name)); ?>" class="btn3">Book</a>
				<p class="price">Ksh <?php echo e($listing->price_per_hall); ?></p>
				</div>
...
mixpanel.init("412a5d35fda9da7599d1efeb1d4bbf06");</script>
