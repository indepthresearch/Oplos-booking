    ...
    <?php if($images != null): ?>
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="img_settings_container" data-field-name="<?php echo e($row->field); ?>" style="float:left;padding-right:15px;">
                <img src="<?php echo e(Voyager::image( $image )); ?>" data-image="<?php echo e($image); ?>" data-id="<?php echo e($dataTypeContent->id); ?>" style="max-width:200px; height:auto; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:5px;">
