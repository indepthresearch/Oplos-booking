...
<div class="super_container">
	...
	<div class="home">
	   ...
	   <?php $__currentLoopData = $accomodations->slice(0, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accomodation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   <?php echo e($loop->parent); ?> 
   	    <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="<?php echo e(route('accomodation',$accomodation->price)); ?>">
			    <img src="images/l5.jpg" class="img-responsive" alt=""/>
			    <div class="ribbon green"><span>Ksh <?php echo e($accomodation->price); ?></span></div>
				<span class="sale-box">
				  <span class="sale-label">-17%</span>
			    </span>
				</a>
				<div class="living_desc">
				<h3><a href="<?php echo e(route('accomodation',$accomodation->price)); ?>"><?php echo e($accomodation->property_name); ?></a></h3>
				<p>Room Type: <?php echo e($accomodation->room_type); ?> </p>
				<p>Maximum Occupacy: <?php echo e($accomodation->maximum_occupancy); ?> </p>
				<p>Location: <?php echo e($accomodation->location); ?> </p>
				<ul><span class="glyphicon glyphicon-star" aria-hidden="true"></span>
				<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
		        </ul>
				<a href="<?php echo e(route('accomodation',$accomodation->price)); ?>" class="btn3">Book</a>
				<p class="price">Ksh <?php echo e($accomodation->price); ?></p>
				</div>
			    <table border="1" class="propertyDetails">
                <tbody><tr>
                   <td><img src="images/area.png" alt="" style="margin-right:7px;"><?php echo e($accomodation->Area); ?> M</td>
                   <td><img src="images/bed.png" alt="" style="margin-right:7px;"><?php echo e($accomodation->beds); ?></td>
