...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('styles/autocomplete.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('styles/tables.css')); ?>">
...
<div class="super_container">
   ...
   <h2 class="title block-title">Your Search Results</h2>
   <p><?php echo e($listings->total()); ?> Result(s) for '<?php echo e(request()->input('query')); ?>'</p>
   ...
   <?php if($listings->total() > 0): ?>
    <div class="living_middle">
	   ...
	   <?php $__currentLoopData = $listings->slice(0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		 ...
		 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   	     ...
   	     <?php echo e($listings->appends(request()->input())->links()); ?>
   ...
   <!-- <table class="table table-bordered table-striped">
            ...
            <tbody>
                 <?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th><a href="<?php echo e(route('product.show',$listing->property_name)); ?>"><?php echo e($listing->property_name); ?></a></th>
                        <td><?php echo e($listing->location); ?></td>
                        <td><?php echo e(str_limit($listing->Description, 80)); ?></td>
                        <td><?php echo e($listing->Capacity); ?></td>
                        <td><?php echo e($listing->price_per_hall); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table> -->
