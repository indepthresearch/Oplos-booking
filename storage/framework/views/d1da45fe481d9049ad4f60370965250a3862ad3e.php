...
<!-- Offers -->
		...
		<div class="living_middle">
   	  <div class="container">
   	  	<form>
   	  		<h2 class="title block-title">Get a deal of a lifetime with us .Book Now</h2>
       <div class="form-group">
	   <?php $__currentLoopData = $listings->slice(0, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   <?php echo e($loop->parent); ?> 
   	    <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="<?php echo e(route('product.show',$listing->property_name)); ?>">
				...
				<h3><a href="<?php echo e(route('product.show',$listing->property_name)); ?>"><?php echo e($listing->property_name); ?></a></h3>
