	...
	<!-- Search -->
								...
								<div class="container wrapper">
														...
														<div class="row cart-body content-justified-right">
																<form class="form-horizontal" method="post" action="{{route('book.checkout','$listing')}}" id="payment-form">
																<input type="hidden"{{ csrf_token() }} name="">
																				...
																				@foreach(Cart::content() as $item)
																						<div class="form-group">
																								<div class="col-sm-3 col-xs-3">
																										<img class="img-responsive" src="C:\xampp\htdocs\bookings\Bookings\storage\app\public\accomodations\September2018\6F4zqnqup49tvjRIPggo.jpg" />
																								</div>
																								<div class="col-sm-6 col-xs-6">
																										<div class="col-xs-12">{{$item->model->property_name}}</div>
																										<div class="col-xs-12"><small>Quantity:<span>{{Cart::count()}}</span></small></div>
																								</div>
																								<div class="col-sm-3 col-xs-3 text-right">
																										<h6><span>Ksh</span> {{$item->model->price_per_hall}}</h6>
																								</div>
																						</div>
																						@endforeach
																...
																<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
																	...
																	<button type="submit" name="submit" id="complete-order" class="button-primary full-width">Complete Booking</button>
																	</div>
