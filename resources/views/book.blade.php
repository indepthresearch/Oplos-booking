								...
								<div class="container wrapper">
														<div class="row cart-head">
														 ...
														 @if (session()->has('success_message'))
																...
																@endif
																@if(Cart::count() > 0)
																<h2>{{Cart::count()}} Hotel Already Booked proceed to payment</h2>
					<div class="d-flex justify-content-center">
				<div class="row cart-body content-justified-right">
	 
        <div class="checkout-section">
            <div>
                <form action="{{route('book.checkout','$listing')}}" method="POST" id="payment-form">
					@csrf
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
													...
													<div class="col-xs-12">{{isset($item->model->property_name)?$item->model->property_name:''}}
													</div>
												<div class="col-xs-12"><small>Location:<span>{{isset($item->model->location)?$item->model->location:''}}</span></small></div>
											{{--<div class="col-xs-12"><small>CheckIn:<span>{{isset($item->model->TimeStamp)?($item->model->TimeStamp:''}}</span></small></div>
											<div class="col-xs-12"><small>CheckOut:<span>{{isset($item->model->TimeStamp)?($item->model->TimeStamp:''}}</span></small></div> --}}
														</div>
											<div class="col-sm-3 col-xs-3 text-right">
													<h6><span>Ksh</span> {{isset($item->model->price_per_hall)?$item->model->price_per_hall:''}}</h6>
																								</div>
																						</div>
																						@endforeach
																						...
																						<div class="form-group">
																								<div class="col-xs-12">
																										...
																										<div class="pull-right"><span>Ksh</span><span>{{Cart::subtotal()}}</span></div>
																								</div>
																								<div class="col-xs-12">
																										<small>VAT(16%)</small>
																						...
																						<div class="form-group">
																								<div class="col-xs-12">
																										...
																										<div class="pull-right"><span>Ksh</span><span>{{Cart::total()}}</span></div>
																								</div>
																						</div>
																						@else
																						<h3>No Hotel Selected yet <a href="{{route('deals')}}">Go to Home</a><h3>
                    ...
                    <div class="half-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone_number" name="phone" value="{{ old('phone') }}" required>
                        </div>
                    </div> <!-- end half-form -->
