        ...
        @endif
				...
				<div class="single-page">
							...
							<div class="single-pg-hdr">
												...
												<h2>{{$accomodation->property_name}}</h2>
                                  ...
                                  <img class="img-fluid" src="http://placehold.it/850x500" alt="">
												...
												<p>
													<h1>About  {{$accomodation->property_name}}</h1>
						...
						<div class="col-md-4 single-gd-rt">
							<div class="spl-btn">
								...
								<div class="sp-bor-btn text-right">
                                    {{$accomodation->property_name}}
									<h4><span>Ksh 8,750</span> {{$accomodation->price}}</h4>
					...
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="{{route('book.show')}}"><img class="img-fluid" src="http://placehold.it/500x300" alt=""></a>
								<div class="room-basic-info">
									<a href="{{route('book.show')}}">{{$accomodation->room_type}}</a>
									<h6>Room Capacity:</h6>
									<p>{{$accomodation->maximum_occupancy}} People</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								...
								<p>Price is now:</p>
								<span class="p-offer">Ksh {{$accomodation->price}}</span>
            	...
            	<div class="p-table-grad-heading">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
								<form action="{{ route('cart.store',$accomodation) }}" method="POST">
								{{ csrf_field() }}
								<input type="hidden" name="id" value="{{$accomodation->id}}">
								<input type="hidden" name="property_name" value="{{$accomodation->property_name}}">
								<input type="hidden" name="price_per_hall" value="{{$accomodation->price}}">
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								...
								<div class="room-basic-info">
									<a href="book">{{$accomodation->room_type}}</a>
									<h6>Room Capacity:</h6>
									<p>{{$accomodation->maximum_occupancy}} People</p>
								</div>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">{{$accomodation->price}}</span>
