        ...
        @endif
				...
				<div class="single-page">
							...
							<div class="single-pg-hdr">
												...
												<h2>{{isset($listing->property_name)?$listing->property_name:''}}</h2>
												<p>Location: {{isset($listing->location)?$listing->location:''}}</p>
                                            ...
                                            <img class="img-fluid" src="../images/l5.jpg" alt="logo">
												...
												<p>
													<h1>About  {{isset($listing->property_name)?$listing->property_name:''}}</h1>
						...
						<div class="col-md-4 single-gd-rt">
							<div class="spl-btn">
								...
								<div class="sp-bor-btn text-right">
                                    {{isset($listing->property_name)?$listing->property_name:''}}
									<h4><span>Ksh 8,750</span> {{isset($listing->price_per_person)?$listing->price_per_person:''}}</h4>
					...
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="{{route('book.show')}}"><img class="img-fluid" src="../images/l5.jpg" alt="logo">
          </a></a>
								<div class="room-basic-info">
									<a href="{{route('book.show')}}">Classroom Conference Room</a>
									<h6>Room Capacity:</h6>
									<p>{{isset($listing->Capacity)?$listing->Capacity:''}} People</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								...
								<p>Price is now:</p>
								<span class="p-offer">Ksh {{isset($listing->price_per_metre)?$listing->price_per_person:''}}</span>
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
									<form action="{{ route('cart.store',$listing) }}" method="POST">
										@csrf
								<input type="hidden" name="id" value="{{$listing->id}}">
								<input type="hidden" name="property_name" value="{{$listing->property_name}}">
								<input type="hidden" name="price_per_hall" value="{{$listing->price_per_person}}">
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">{{isset($listing->price_per_hall)?$listing->price_per_metre:''}}</span>
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
								...
								<input type="hidden" name="id" value="{{$listing->id}}">
								<input type="hidden" name="property_name" value="{{$listing->property_name}}">
								<input type="hidden" name="price_per_hall" value="{{$listing->price_per_metre}}">
								<button type="submit" class="button-button-primary">Book</button>
							</form>
							</div>
						</div>
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">{{isset($listing->price_per_hall)?$listing->price_per_hall:''}}</span>
								<span class="p-last-price">Ksh23,000</span>
							</div>
						</div>
						 <div class="row">
          ...
          <div class="card">
            ...
            <div class="col-md-3 p-table-grid">
							...
							<div class="book-button-column">
								...
								<input type="hidden" name="id" value="{{$listing->id}}">
								<input type="hidden" name="property_name" value="{{$listing->property_name}}">
								<input type="hidden" name="price_per_hall" value="{{$listing->price_per_hall}}">
								<button type="submit" class="button-button-primary">Book</button>
							</form>
							</div>
						</div>
					...
					<div class="p-table-grids">
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">{{$listing->price_per_hall}}</span>
								<span class="p-last-price">Ksh23,000</span>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
				...
				<div class="p-table">
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="{{route('book.show')}}"><img src="images/images (7).jpg" alt=""></a>
								<div class="room-basic-info">
									<a href="{{route('book.show')}}">Classroom Conference Room</a>
									<h6>Room Capacity:</h6>
									<p>{{$listing->Capacity}} People</p>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">Ksh {{$listing->price_per_metre}}</span>
								<span class="p-last-price">Ksh1930</span>
							</div>
						</div>
						<div class="col-md-3 p-table-grid">
				...
				<div class="p-table">
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="{{route('book.show')}}"><img src="images/conference8.jpg" alt=""></a>
								<div class="room-basic-info">
									<a href="{{route('book.show')}}">Theatre Confrerence Room</a>
									<h6>Room Capacity:</h6>
									<p>{{$listing->Capacity}} People</p>
								</div>
							</div>
						...
						<div class="col-md-3 p-table-grid">
							...
							<div class="avg-rate">
								<h5>Recommended for you</h5>
								<p>Price is now:</p>
								<span class="p-offer">Ksh {{$listing->price_per_person}}</span>
